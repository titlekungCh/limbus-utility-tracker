...
// Extra-keyword option lists (the sheet's ID Level M / EGO Tier L data validations).
// Shared within each category; the two lists differ slightly.
export const EXTRA_KEYWORD_ID = ["Paralyze", "Bind", "Haste", "Protection", "Attack Type DMG/Power Up", "Sin DMG/Power Up", "Ammo", "Plus Coin Drop", "Offense Level Up", "Offense Level Down", "Defense Level Up", "Defense Level Down", "Damage Up", "Retreat", "Reload", "Assist Attack", "Assist Defense", "Defense Power Up", "Defense Power Down", "Damage Down", "Amplitude Conversion", "Amplitude Entanglement", "Aggro", "Attack Power Up", "Attack Power Down", "Power Up", "Power Down", "Plus Coin Boost", "Fragile", "Attack Type Fragility", "Sin Fragility", "Attack Type Protection", "Keyword Protection", "Unbreakable Coin", "Unfocused Volley", "Attack Type Resist Down", "Sin Resist Down", "Clash Power Up", "Shin", "Load", "Photoelectricity", "Dimensional Rift", "Tremor Burst", "Tremor - Superposition", "Tremor - Chain", "Tremor - Decay", "Tremor - Reverb", "Tremor - Scorch", "Tremor - Hemorrhage", "Discard", "Clashable Guard", "Clashable Counter", "Bloodfeast", "Deathrite", "Crit DMG Up", "HP Healing Down", "Nail", "Curse"];
export const EXTRA_KEYWORD_EGO = ["Paralyze", "Bind", "Haste", "Protection", "Attack Type DMG/Power Up", "Sin DMG/Power Up", "Ammo", "Plus Coin Drop", "Offense Level Up", "Offense Level Down", "Defense Level Up", "Defense Level Down", "Damage Up", "Retreat", "Reload", "Assist Attack", "Assist Defense", "Defense Power Up", "Defense Power Down", "Damage Down", "Amplitude Conversion", "Amplitude Entanglement", "Aggro", "Attack Power Up", "Attack Power Down", "Power Up", "Power Down", "Plus Coin Boost", "Fragile", "Attack Type Fragility", "Sin Fragility", "Sin Protection", "Attack Type Protection", "Keyword Protection", "Unbreakable Coin", "Unfocused Volley", "Attack Type Resist Down", "Sin Resist Down", "Clash Power Up", "Clash Power Down", "Shin", "Load", "Photoelectricity", "Dimensional Rift", "Tremor Burst", "Tremor - Superposition", "Tremor - Chain", "Tremor - Decay", "Tremor - Reverb", "Tremor - Scorch", "Tremor - Hemorrhage", "Tremor - Fracture", "Tremor - Everlasting", "Tremor - Clockwinding", "Discard", "Clashable Guard", "Clashable Counter", "Bloodfeast", "Deathrite", "Crit DMG Up", "Weak-resist DMG Boost", "SP Healing Efficiency", "SP Loss Efficiency", "E.G.O Resource Amp", "Nail", "Curse"];

...
| `season/` | Season number | `season-icons/` (`s-0`..`s-7`) | source only has seasons 1–7; `s-0` kept raw |
| `walpurgis/` | Walpurgisnaught | `season-icons/` (`w-1`..`w-8`) | one per Walpurgis event; the app has a single Walpurgisnaught tag |
